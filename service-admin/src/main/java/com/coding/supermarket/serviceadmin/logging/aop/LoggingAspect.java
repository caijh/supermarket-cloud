package com.coding.supermarket.serviceadmin.logging.aop;
...
public class LoggingAspect {
    ...
    public void before(JoinPoint joinPoint) throws NoSuchMethodException {
        ...
        LOGGER.debug("Arguments: {}", reqBody);
        ...
        LOGGER.info("Method Type: {}, Request Path info: {}, Request Body: {}", requestMethod, contextPath, reqBody);
    }
